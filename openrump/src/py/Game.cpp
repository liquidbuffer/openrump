...
void exportPyGame()
{
    ...
    class_<OpenRump::Game, boost::noncopyable>("Game")
        ...
        .def("orbit_camera_around_entity", &OpenRump::Game::orbitCameraAroundEntity)
        .def("orbit_camera_around_node", &OpenRump::Game::orbitCameraAroundNode)
        .def("detach_camera_from_orbit", &OpenRump::Game::detachCameraFromOrbit)
